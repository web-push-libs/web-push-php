...
class TestCase extends \PHPUnit\Framework\TestCase
{
    ...
    public function getAuthorization(): Authorization
    {
        ...
        return new Authorization('vplfkITvu0cwHqzK9Kj-DYStbCH_9AhGx9LqMyaeI6w', 'BMBlr6YznhYMX3NgcWIDRxZXs0sh7tCv7_YCsWcww0ZCv9WGg-tRCXfMEHTiBPCksSqeve1twlbmVAZFv7GSuj0', $subjects[array_rand($subjects)]);
    }

    public function getSubscription(): Subscription
    {
        return new Subscription('https://foo.bar', 'BCVxsr7N_eNgVRqvHtD0zTZsEc6-VV-JvLexhqUzORcxaOzi6-AYWXvTBHm4bjyPjs7Vd8pZGH6SRpkNtoIAiw4', 'BTBZMqHH6r4Tts7J_aSIgg', 'aesgcm');
    }
