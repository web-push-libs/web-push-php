...
class VAPID
{
    ...
    public static function validate(array $vapid): array
    {
        ...
        if (isset($vapid['pem'])) {
            ...
            if ('EC' !== $jwk->get('kty') || !$jwk->has('d') || !$jwk->has('x') || !$jwk->has('y')) {
        ...
        if (self::PUBLIC_KEY_LENGTH !== Utils::safeStrlen($publicKey)) {
        ...
        if (self::PRIVATE_KEY_LENGTH !== Utils::safeStrlen($privateKey)) {
